...
<ol class="relative border-l border-gray-200 dark:border-gray-700 list-none overflow-visible">                  
  <li class="mb-10 ps-6 relative">
    <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-[1.5rem] top-1 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
