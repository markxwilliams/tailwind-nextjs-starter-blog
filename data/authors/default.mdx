...
<ol class="relative border-l border-gray-200 dark:border-gray-700 list-none">                  
  <li class="mb-10 ms-6 relative">
    <!-- Timeline dot (centered over the border) -->
    <span class="absolute -left-3 flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
