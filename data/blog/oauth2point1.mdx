---
title: 'What is New in OAuth2.1?'
date: '2025-05-04'
lastmod: '2025-05-04'
tags: ['ciam']
draft: false
summary: 'What's New in OAuth2.1?'
...
- PKCE is required for both public and confidential clients when using an authorisation code grant. 
- The implicit grant and resource owner grant were removed. 
- The definitions of public and confidential clients have been simplified: Clients that have credentials with the authorisation server are designated as “confidential clients”. Clients without credentials are called “public clients”.
